...
export default function Home() {
	return (
        ...
        <Link href={"/letters"} className="btn btn-lg w-[60vw] lg:w-[40vw] border-none animate-button bg-gradient-to-br from-emerald-500 via-sky-700 to-blue-800 dark:from-yellow-200 dark:via-orange-400 dark:to-rose-500 text-white dark:text-neutral-800 text-2xl drop-shadow-[0px_0px_10px_theme(colors.primary)] dark:drop-shadow-[0px_0px_4px_theme(colors.secondary)]">
            Letters
        </Link>
        <Link href={"/numbers"} className="btn btn-lg w-[60vw] lg:w-[40vw] border-none animate-button bg-gradient-to-br from-emerald-500 via-sky-700 to-blue-800 dark:from-yellow-200 dark:via-orange-400 dark:to-rose-500 text-white dark:text-neutral-800 text-2xl drop-shadow-[0px_0px_10px_theme(colors.primary)] dark:drop-shadow-[0px_0px_4px_theme(colors.secondary)]">
            Numbers
        </Link>
			</div>
		</main>
