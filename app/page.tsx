...
export default function Home() {
	return (
        ...
        <Link href={"/letters"} className="flex items-center text-white bg-gradient-to-br from-slate-400 to-slate-600 hover:bg-gradient-to-tl focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-orange-500/50 dark:shadow-lg dark:shadow-yellow-800/80 font-medium rounded-lg text-2xl lg:text-4xl px-12 lg:px-32 py-4 text-center">
            Letters
        </Link>
        <Link href={"/numbers"} className="flex items-center text-white bg-gradient-to-br from-slate-400 to-slate-600 hover:bg-gradient-to-tl focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-orange-500/50 dark:shadow-lg dark:shadow-yellow-800/80 font-medium rounded-lg text-2xl lg:text-4xl px-12 lg:px-32 py-4 text-center">
            Numbers
        </Link>
			</div>
		</main>
